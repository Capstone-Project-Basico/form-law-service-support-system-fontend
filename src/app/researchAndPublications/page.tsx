  ...
  return (
    ...
    <div className="flex flex-col absolute z-20 inset-0 p-24 text-white mx-[366px] ">
      ...
      <div className="min-h-20">
        ...
        <div className="text-xl text-white pt-5 font-lora italic opacity-80"style={{ letterSpacing: '1px' }}>Có hàng nghìn bài viết, báo chí đăng tải, báo chí phỏng vấn, trích dẫn …</div>
      </div>
