...
const page = (prop: Header) => {
  ...
  <h1 className="text-3xl font-bold text-gray-800">THAM GIA ỨNG TUYỂN</h1>
  <button className="bg-[#419641] text-white px-6 py-3 rounded-full hover:bg-green-600 focus:outline-none focus:ring-2 focus:ring-green-700 focus:ring-opacity-50">
    ...
    <div className="text-center pb-">
        <h2 className="text-3xl pb-3 font-semibold text-gray-800"><strong>
      ...
      <div className="pl-4 pr-10 py-2 rounded-lg bg-gray-100 shadow-inner">
        ...
        <p className="text-gray-800">01 Khát vọng trở thành luật sư giỏi</p>
    </div>
     </div>
  <div className="pl-4 pr-10 py-2 rounded-lg bg-gray-100 shadow-inner">
    <div className="flex items-center space-x-2">
      <span className="text-red-500">✔</span>
      <p className="text-gray-800 text-3">02 Hiểu, tin tưởng và muốn góp sức chinh phục các mục tiêu của BASICO</p>
    </div>
  </div>
</div>
  </div>
