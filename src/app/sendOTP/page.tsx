        ...
        <div className="flex flex-col justify-center items-center mt-51">
          ...
          <div className="pt-5">
            <form >
              ...
              <div className="">
                <Button type="submit" className="border border-#ff0000 bg-[white] text-#ff0000 w-full my-4">
                  Tôi không nhận được mã
                </Button>
              </div>
              <div className="flex justify-center">
                <strong>
                  <a href="/login" className="text- hover:text-[#ff0000]">Quay lại đăng nhập</a></strong>
