...
const Page = () => {
    ...
    const fetchTypes = () => {
        try {
            axios.get(`${process.env.NEXT_PUBLIC_BASE_API}formType/getAllFormTypes`)
                .then((response) => {
    ...
    const handleUpdateSubmit = (e: FormEvent, onClose: () => void) => {
        ...
        try {
            axios.put(`${process.env.NEXT_PUBLIC_BASE_API}formType/updateFormType/${selectedFormType?.id}`,
                selectedFormType,
                { headers: authHeader() }
            )
                .then(() => {
    ...
    const handleDelete = (id: number) => {
        try {
            axios.delete(`${process.env.NEXT_PUBLIC_BASE_API}formType/deleteFormType/${id}`)
                .then(() => {
