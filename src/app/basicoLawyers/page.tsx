      ...
      <div className="relative w-full h-[300px] ">
        ...
        <div className="flex flex-col absolute z-20 inset-0 p-24 text-white mx-[366px] ">
          ...
          <div className="min-h-20">
            ...
            <div className="text-xl text-white pt-5 font-lora italic opacity-80" style={{ letterSpacing: '1px' }}>BASICO đồng hành với quý khách hàng xây dựng nền tảng kinh doanh bền vững.</div>
          </div>
