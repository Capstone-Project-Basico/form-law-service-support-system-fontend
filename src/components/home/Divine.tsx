...
const Divine = () => {
  return (
    <div className="flex lg:flex-row md:flex-col justify-center items-center relative ">
      {/* div 1 */}
      <div className="bg-[#ff0004] text-white text-right pr-5 pl-44 pt-20 pb-20">
        <div className="mb-4 text-2xl font-bold ">DỊCH VỤ PHÁP LÝ</div>
        <p className="mb-4 text-xl">
          BASICO là ưu tiên lựa chọn số một của nhiều doanh nghiệp dẫn đầu trong
          nhiều ngành nghề, lĩnh vực kinh doanh tại Việt Nam
        </p>
        <button className="border-white border-solid border-2 p-2 hover:bg-white hover:text-black">
          <a href="practices">TÌM HIỂU</a>
        </button>
      </div>
      {/* div 2 */}
      <div className="bg-black text-white pr-44 pl-5 pt-20 pb-20">
